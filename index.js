...
(function () {
    ...
    function updateMinimap(sceneId) {
        ...
        // Vérifie si l'élément minimap-img existe
        if (minimapImg) {
            console.log("Mise à jour de la minimap pour la scène : ", sceneId); // Pour vérifier l'ID de la scène

            // Mise à jour de l'image de la minimap en fonction de la scène
            switch (sceneId) {
                case 'salon':
            ...
            console.error("Élément de minimap introuvable");
        }
    }
